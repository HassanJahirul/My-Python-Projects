...
- Python : It helped me analyse massive amount of data through differnt functions available. It also provided a number of useful libraries which were used in different areas of this project. Some of the libraries that were used are :
...
**Graph :**  
![EDA_1](Project_Resources/Graph_1.png)   
**Insights :**
...
Inorder to have a better understanding of our customers preferences, I wanted to see what mode of delivery they preffered over the others. I also wanted see how differnet segments of our customer differed in their opinion. After performing my analysis, I obtained the graph below.  
**Graph :**  
![EDA_2](Project_Resources\Graph_2.png)
**Insights :** 
- There is only slight differnce in prefernces among all the three segments.
- Major portion of our cutomer base (more than **half**) preffered standard class delivery.
- Less than **10%** preffered same day delivery. We may have to lower the price or provide additional benifits inorder to make it more appealing to our customers.
...
I wanted to know how each category of products peformed in terms of sales, so to find this information I decided to plot the total montly sales of each category over 2017.  
 Inorder to find the code and steps I have taken, please reffer this notebook : [3_Sales_Analysis](3_Sales_Analysis.ipynb)  
**Graph :**
![Sales_Chart](Project_Resources\Graph_3.png)  
**Insights :**  
...
**Graph :**  
![Customer_Chart](Project_Resources\Graph_4.png)  
**Insights :**
...
**Graph :**  
![States_Chart](Project_Resources\Graph_5.png)  
**Insights :**
...
**Graph :**  
![RCR_Chart](Project_Resources\Graph_6.png)  
**Insights :**
